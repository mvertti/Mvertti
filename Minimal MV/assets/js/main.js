...
$(window).on('load', function() {
    ...
    // 4. MOTOR DE ZOOM INTELIGENTE (Clic, Pellizco y Arrastre Ultra Fluido)
            ...
            if (!img.dataset.zoomActivo) {
                ...
                img.addEventListener('click', function(e) {
                    ...
                    if (!this.classList.contains('zoomed')) {
                        // Limpiamos todo al hacer clic
                        pista.querySelectorAll('img').forEach(item => {
                            item.classList.remove('zoomed');
                            item.style.transition = ''; // Restauramos animaciones
                        });
                ...
                // --- 2. SENSORES DE PELLIZCO Y ARRASTRE A 60 FPS (MÓVIL) ---
                ...
                img.addEventListener('touchstart', function(e) {
                    if (e.touches.length === 2) {
                        ...
                        // ¡LA MAGIA! Apagamos la animación de CSS temporalmente para que no haya tirones
                ...
                img.addEventListener('touchmove', function(e) {
                    ...
                    if (e.touches.length === 2 && distanciaInicialPellizco !== null) {
                        ...
                        if (distanciaActual < distanciaInicialPellizco - 30) {
                            this.classList.remove('zoomed');
                            this.style.transition = ''; // Restaurar animación
                        }
                    } 
                    // B. ARRASTRE LIBRE Y FLUIDO
                        ...
                        // Sensibilidad ajustada para que el dedo no resbale
                        ...
                        // Motor de renderizado ultra rápido (Evita atascos en la memoria del celular)
                ...
                img.addEventListener('touchend', function(e) {
                    ...
                    if (e.touches.length === 0) {
                        isDragging = false;
                        // ¡SÚPER IMPORTANTE! Volvemos a encender la animación suave al soltar el dedo
