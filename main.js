const PORTFOLIO_DATA = {
    ...
    about: {
        title: "SOBRE MÍ",
        // Ahora puedes poner etiquetas <p> para crear párrafos separados
        text: "<p>Montserrat Vertti, también conocida como MVertti, es una artista visual y fotógrafa mexicana egresada de la Facultad de Artes de la Universidad Autónoma del Estado de México. Su trabajo se ha consolidado dentro de la fotografía de retrato artístico, desarrollando una propuesta visual íntima y simbólica donde convergen la sensibilidad humana y la estética.</p><p>Bajo el sello de MVertti, “Personas únicas como el Arte”, busca retratar la esencia irrepetible de cada individuo, entendiendo a las personas como obras vivas cargadas de historia, emoción y belleza propia. Su formación artística se complementa con diplomados en Historia del Arte, Arte y Sophia, y Arte y Mitología, estudios que fortalecieron una mirada influenciada por la filosofía y el simbolismo pictórico y escultórico de distintas épocas.</p><p>A lo largo de su trayectoria ha sido reconocida por la fuerza narrativa y emocional de su obra. Actualmente desarrolla proyectos fotográficos enfocados en la lactancia materna, desde donde promueve la empatía, el respeto y la dignificación de las maternidades a través de la imagen. Como fotógrafa y artista, Montserrat entiende la imagen como un espacio de encuentro humano y expresión emocional.</p>",
        photo: "img/mon.jpg"
    },
    services: [
        {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById('about-text').innerHTML = PORTFOLIO_DATA.about.text;
